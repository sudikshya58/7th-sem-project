  ...
  <div>
    <img src="https://i.pinimg.com/originals/33/30/85/333085dde650f2947ee328bd4e1870e2.jpg" alt="about" className="h-96 w-[100vw] object-cover"/>
       ...
       <div className="mr-[4rem] ml-[4rem] text-justify mt-10 text-[20px] ">
        ...
        <p  className="text-gray-600"> We are committed to transparency, accessibility, and empowerment. Our mission is to provide users with the resources they need to take control of their financial well-being, guiding them towards a more secure and prosperous future.</p>
        <p className="text-gray-600">Join us on this journey towards financial empowerment. Let Credence be your trusted partner in making smarter, more informed financial decisions.</p>
       </div>
    </div>
    <Footer/>
  </>
